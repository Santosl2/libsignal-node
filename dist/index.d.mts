...
declare function decipherivEncrypt(key: Uint8Array, data: Uint8Array, iv: Uint8Array): Buffer<ArrayBuffer>;
declare function decipherivDecrypt(key: Uint8Array, data: Uint8Array, iv: Uint8Array): Buffer<ArrayBuffer>;

declare const KEY_BUNDLE_TYPE: Uint8Array<ArrayBuffer>;
declare const Curve: {
    ...
    signedKeyPair: (identityKeyPair: KeyPair, keyId: number) => {
        keyPair: KeyPair;
        signature: Uint8Array;
        keyId: number;
    };
