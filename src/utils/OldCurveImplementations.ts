...
const prefixKeyInPublicKey = (pubKey: Buffer): Buffer => {
...
export const getPublicFromPrivateKey = (privKey: Buffer): Buffer => {
...
export const generateKeyPair = (): { pubKey: Buffer; privKey: Buffer } => {
  try {
...
export const calculateAgreement = (pubKey: Buffer, privKey: Buffer): Buffer => {
